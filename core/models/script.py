    ...
    for row in df.values:
        ...
        if row[1] is not nan:
            ...
            try:
                ...
                sub_division.sub_sub_division.set(sub_sub_division)
                sub_division.save()
                organization = Organization(title=org)
                organization.subdivisions.set(sub_division)
                organization.save()
            except:
                pass
            try:
                ...
                employee.subdivision.set(sub_division)
                employee.sub_sub_division.set(sub_sub_division)
                employee.save()
            except:
                pass
